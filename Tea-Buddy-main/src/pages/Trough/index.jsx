...
import { Button, Img, Text, Heading, Switch, Input } from "../../components";
...
export default function TroughPage() {
  const tableColumns = React.useMemo(() => {
    ...
    return [
      tableColumnHelper.accessor("troughid", {
        cell: (info) => (
        ...
        header: (info) => (
          <Text as="p" className="pt-[5px] pb-3.5 pl-[23px] sm:pl-5 !text-gray-700 tracking-[0.14px]">
            Trough ID
          </Text>
        ),
        meta: { width: "162px" },
      }),
      tableColumnHelper.accessor("capacity", {
        cell: (info) => (
          <Text as="p" className="!text-black-900 tracking-[0.14px]">
            {info?.getValue?.()}
          </Text>
        ...
        header: (info) => (
          <Text as="p" className="pt-px pb-[18px] !text-gray-700 tracking-[0.14px]">
            Capacity
          </Text>
        ),
        meta: { width: "131px" },
      ...
      tableColumnHelper.accessor("status", {
        cell: (info) => (
          <div className="flex justify-between items-end gap-5 flex-1">
            <div className="flex justify-center items-center w-[47%] mt-7 mb-[18px] gap-[9px]">
              <div className="self-end h-[11px] w-[11px] bg-green-A400 rounded-[5px]" />
              <Text as="p" className="!text-black-900 tracking-[0.14px]">
                {info?.getValue?.()}
              </Text>
            </div>
            <Img src="images/img_edit_1.png" alt="editone_one" className="w-[15px] mb-[15px] mr-[23px] object-cover" />
          </div>
        ),
        header: (info) => (
          <Text as="p" className="pb-[19px] pl-[11px] !text-gray-700 tracking-[0.14px]">
            Status
          </Text>
        ),
        meta: { width: "171px" },
      ...
      <div className="flex md:flex-col justify-center items-start w-full gap-[45px] overflow-auto bg-indigo-50">
        ...
        <div className="flex justify-center w-[88%] md:w-full md:p-5">
          <div className="flex flex-col w-full gap-6">
            ...
            <div className="h-[412px] relative">
              <Img
                src="images/img_arrow_down.svg"
                alt="arrowdown_one"
                className="h-[14px] w-[14px] right-[12%] top-[4%] m-auto absolute"
              />
              <div className="flex flex-col justify-end w-[26%] h-full ml-[110px] gap-[17px] right-[12%] bottom-0 top-0 p-[18px] my-auto border-gray-200_01 border border-solid bg-white-A700_e5 absolute rounded-[10px]">
              ...
              <div className="justify-center h-[412px] w-[1300px] left-0 bottom-0 right-0 top-0 m absolute">
                    ...
                    <div className="h-[412px] w-[63%] relative">
                      ...
                      <div className="flex flex-col items-end w-[37%] gap-[26px] right-[2%] top-[5%] m-auto absolute">
                        <div className="flex justify-end items-center w-[35%] md:w-full gap-[3px]">
                          <Heading size="xs" as="h3" className="!text-gray-600">
                            Aug 25-Sept 25
                          </Heading>
                        ...
                        <div className="self-stretch p-[25px] sm:p-5 bg-light_blue-50 rounded-[10px]">
                          <div className="flex flex-col mb-3.5">
                            <div className="flex items-end mr-[15px] md:mr-0">
                              ...
                              <Heading size="xl" as="h5" className="h-[33px] ml-1">
                                KG
                              </Heading>
                              <Text size="2xl" as="p" className="mb-2.5 ml-[3px] !font-manrope">
                                *
                              </Text>
                              <Heading size="xl" as="h6" className="ml-4">
                                7
                              </Heading>
                      ...
                      <div className="flex flex-col items-end w-[11%] bottom-[17%] left-[6%] m-auto absolute">
                        <div className="flex self-stretch justify-end items-center gap-[5px] mr-[22px]">
                          <div className="h-[10px] w-[10px]  bg-light_blue-50 rounded-[50%]" />
                          <Text as="p" className="!font-manrope">
                            Main Stock
                          </Text>
                        </div>
                        <div className="flex justify-end mt-2 gap-1 mr-[11px]">
            ...
            <div className="flex md:flex-col items-center w-[78%] md:w-full gap-[23px]">
              <div className="flex w-full p-[13px] bg-white-A700">
                <div className="flex w-[89%] md:w-full mt-[46px] mb-[17px]">
                  <div className="flex flex-col items-end w-full">
                    <div className="flex sm:flex-col self-stretch justify-end items-start">
                      <Heading size="s" as="p" className="mt-[7px]">
                        Quantity
                      </Heading>
                    ...
                    <Heading size="s" as="p" className="mt-[-2px] mr-[7px] md:mr-0 z-[1]">
                      Date
                    </Heading>
                  </div>
                </div>
              </div>
              <div className="flex flex-col items-start w-[600px] gap-8 h-[450px] p-[19px] border-gray-200_02 border-2 border-solid bg-white-A700 rounded-[20px]">
                <Heading as="h6" className="mt-[9px] ml-[17px] md:ml-0 !text-gray-900_01">
                  Trough Details
                </Heading>
                <ReactTable
                  size="xs"
                  ...
                  className="w-[465px] ml-[21px] md:ml-0"
                  columns={tableColumns}
                  data={tableData}
                />
                <Button color="gray_300" size="xs" className="self-end w-[31px] rounded-[15px] mb-[100px]">
